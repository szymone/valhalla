...
inline Language stringLanguage(const std::string& s) {
  static const std::unordered_map<std::string, Language> stringToLanguage =
      {{"ab", Language::kAb},          {"am", Language::kAm},   {"ar", Language::kAr},
       ...
       {"vi", Language::kVi},          {"zh", Language::kZh},   {"none", Language::kNone}};
...
inline std::string to_string(Language l) {
  static const std::unordered_map<uint8_t, std::string> LanguageStrings =
      {{static_cast<uint8_t>(Language::kAb), "ab"},
       {static_cast<uint8_t>(Language::kAm), "am"},
       {static_cast<uint8_t>(Language::kAr), "ar"},
       {static_cast<uint8_t>(Language::kAz), "az"},
       {static_cast<uint8_t>(Language::kBe), "be"},
       {static_cast<uint8_t>(Language::kBg), "bg"},
       {static_cast<uint8_t>(Language::kBn), "bn"},
       {static_cast<uint8_t>(Language::kBs), "bs"},
       {static_cast<uint8_t>(Language::kCa), "ca"},
       {static_cast<uint8_t>(Language::kCkb), "ckb"},
       {static_cast<uint8_t>(Language::kCs), "cs"},
       {static_cast<uint8_t>(Language::kDa), "da"},
       {static_cast<uint8_t>(Language::kDe), "de"},
       {static_cast<uint8_t>(Language::kDv), "dv"},
       {static_cast<uint8_t>(Language::kDz), "dz"},
       {static_cast<uint8_t>(Language::kEl), "el"},
       {static_cast<uint8_t>(Language::kEn), "en"},
       {static_cast<uint8_t>(Language::kEs), "es"},
       {static_cast<uint8_t>(Language::kEt), "et"},
       {static_cast<uint8_t>(Language::kFa), "fa"},
       {static_cast<uint8_t>(Language::kFi), "fi"},
       {static_cast<uint8_t>(Language::kFr), "fr"},
       {static_cast<uint8_t>(Language::kFy), "fy"},
       {static_cast<uint8_t>(Language::kGl), "gl"},
       {static_cast<uint8_t>(Language::kHe), "he"},
       {static_cast<uint8_t>(Language::kHr), "hr"},
       {static_cast<uint8_t>(Language::kHu), "hu"},
       {static_cast<uint8_t>(Language::kHy), "hy"},
       {static_cast<uint8_t>(Language::kId), "id"},
       {static_cast<uint8_t>(Language::kIs), "is"},
       {static_cast<uint8_t>(Language::kIt), "it"},
       {static_cast<uint8_t>(Language::kJa), "ja"},
       {static_cast<uint8_t>(Language::kKa), "ka"},
       {static_cast<uint8_t>(Language::kKl), "kl"},
       {static_cast<uint8_t>(Language::kKm), "km"},
       {static_cast<uint8_t>(Language::kKo), "ko"},
       {static_cast<uint8_t>(Language::kLo), "lo"},
       {static_cast<uint8_t>(Language::kLt), "lt"},
       {static_cast<uint8_t>(Language::kLv), "lv"},
       {static_cast<uint8_t>(Language::kMg), "mg"},
       {static_cast<uint8_t>(Language::kMk), "mk"},
       {static_cast<uint8_t>(Language::kMn), "mn"},
       {static_cast<uint8_t>(Language::kMo), "mo"},
       {static_cast<uint8_t>(Language::kMt), "mt"},
       {static_cast<uint8_t>(Language::kMy), "my"},
       {static_cast<uint8_t>(Language::kNe), "ne"},
       {static_cast<uint8_t>(Language::kNl), "nl"},
       {static_cast<uint8_t>(Language::kNo), "no"},
       {static_cast<uint8_t>(Language::kOc), "oc"},
       {static_cast<uint8_t>(Language::kPap), "pap"},
       {static_cast<uint8_t>(Language::kPl), "pl"},
       {static_cast<uint8_t>(Language::kPs), "ps"},
       {static_cast<uint8_t>(Language::kPt), "pt"},
       {static_cast<uint8_t>(Language::kRm), "rm"},
       {static_cast<uint8_t>(Language::kRo), "ro"},
       {static_cast<uint8_t>(Language::kRu), "ru"},
       {static_cast<uint8_t>(Language::kSk), "sk"},
       {static_cast<uint8_t>(Language::kSl), "sl"},
       {static_cast<uint8_t>(Language::kSq), "sq"},
       {static_cast<uint8_t>(Language::kSr), "sr"},
       {static_cast<uint8_t>(Language::kSrLatn), "sr-Latn"},
       {static_cast<uint8_t>(Language::kSv), "sv"},
       {static_cast<uint8_t>(Language::kTg), "tg"},
       {static_cast<uint8_t>(Language::kTh), "th"},
       {static_cast<uint8_t>(Language::kTk), "tk"},
       {static_cast<uint8_t>(Language::kTr), "tr"},
       {static_cast<uint8_t>(Language::kUk), "uk"},
       {static_cast<uint8_t>(Language::kUr), "ur"},
       {static_cast<uint8_t>(Language::kUz), "uz"},
       {static_cast<uint8_t>(Language::kVi), "vi"},
       {static_cast<uint8_t>(Language::kZh), "zh"},
       {static_cast<uint8_t>(Language::kNone), "none"}};

  auto i = LanguageStrings.find(static_cast<uint8_t>(l));
